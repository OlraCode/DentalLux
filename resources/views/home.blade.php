    ...
    <main class="max-w-[1600px] mx-auto flex-1">
        ...
        <div class="mt-16 flex flex-col items-center">
            ...
            <div class="flex flex-wrap justify-center gap-5 mt-6">
                <div class="bg-white p-8 rounded-xl w-90 shadow-md hover:shadow-xl transition-shadow overflow-hidden">
                    <div class="h-2 bg-linear-to-r from-sky-200 to-sky-500 relative -top-8 -left-8 w-90"></div>
                ...
                <div class="bg-white p-8 rounded-xl w-90 shadow-md hover:shadow-xl transition-shadow relative overflow-hidden">
                    <div class="h-2 bg-linear-to-r from-purple-200 to-purple-500 relative -top-8 -left-8 w-90"></div>
                ...
                <div class="bg-white p-8 rounded-xl w-90 shadow-md hover:shadow-xl transition-shadow relative overflow-hidden">
                    <div class="h-2 bg-linear-to-r from-green-200 to-green-500 relative -top-8 -left-8 w-90"></div>
                ...
                <div class="bg-white p-8 rounded-xl w-90 shadow-md hover:shadow-xl transition-shadow relative overflow-hidden">
                    <div class="h-2 bg-linear-to-r from-orange-200 to-orange-500 relative -top-8 -left-8 w-90"></div>
        ...
        <div class="flex flex-col justify-center items-center mt-32">
            ...
            <div class="flex flex-wrap justify-center gap-10 mt-8">
                <div class="flex flex-col justify-between bg-white shadow-md hover:shadow-xl transition-shadow rounded-xl p-5 w-90 h-50">
                    <h2>⭐⭐⭐⭐⭐</h2>
