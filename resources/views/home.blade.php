...
@section('content')
    ...
    <main class="max-w-[1600px] mx-auto flex-1">
        <div class="text-center md:text-left md:flex items-center mt-12">
            ...
            <div class="basis-7/10">
                <img src="{{ asset('img/destist.png') }}" alt="Consultório" class="w-full mx-auto rounded-2xl">
            </div>
        </div>
        
        <div class="md:mt-32 mt-8 flex items-center justify-center gap-5">
            <div class="hidden md:block basis-5/10">
                <img src="{{ asset('img/consulta.png') }}" class="w-full">
            </div>
            <div class="px-2 text-center" id="about">
        ...
        <div class="mt-16 flex flex-col items-center">
            <h1 class="text-5xl mb-1 text-center">Nossos Serviços</h1>
            <p class="text-lg text-center">Tratamentos completos para todas as suas necessidades odontológicas.</p>

            <div class="flex flex-wrap justify-center gap-5 mt-6">
                <div class="bg-white p-8 rounded-xl md:w-90 w-80 shadow-md hover:shadow-xl transition-shadow overflow-hidden">
                    <div class="h-2 bg-linear-to-r from-sky-200 to-sky-500 relative -top-8 -left-8 md:w-90 w-80"></div>
                    <img src="{{ asset('img/sparkle.png') }}" class="bg-linear-to-br from-sky-200 to-sky-500 rounded-2xl w-15 p-3 mb-3">
                    <h2 class="text-2xl">Limpeza Dental</h2>
                    <p>Profilaxia completa para manter seus dentes sempre saudáveis</p>
                </div>
                <div class="bg-white p-8 rounded-xl md:w-90 w-80 shadow-md hover:shadow-xl transition-shadow relative overflow-hidden">
                    <div class="h-2 bg-linear-to-r from-purple-200 to-purple-500 relative -top-8 -left-8 md:w-90 w-80"></div>
                    <img src="{{ asset('img/star.png') }}" class="bg-linear-to-br from-purple-200 to-purple-500 rounded-2xl w-15 p-3 mb-3">
                    <h2 class="text-2xl">Clareamento</h2>
                    <p>Tecnologia LED para um sorriso mais branco e radiante</p>
                </div>
                <div class="bg-white p-8 rounded-xl md:w-90 w-80 shadow-md hover:shadow-xl transition-shadow relative overflow-hidden">
                    <div class="h-2 bg-linear-to-r from-green-200 to-green-500 relative -top-8 -left-8 md:w-90 w-80"></div>
                    <img src="{{ asset('img/shield.png') }}" class="bg-linear-to-br from-green-200 to-green-500 rounded-2xl w-15 p-3 mb-3">
                    <h2 class="text-2xl">Implantes</h2>
                    <p>Implantes de última geração com garantia e conforto</p>
                </div>
                <div class="bg-white p-8 rounded-xl md:w-90 w-80 shadow-md hover:shadow-xl transition-shadow relative overflow-hidden">
                    <div class="h-2 bg-linear-to-r from-orange-200 to-orange-500 relative -top-8 -left-8 md:w-90 w-80"></div>
                    <img src="{{ asset('img/medal.png') }}" class="bg-linear-to-br from-orange-200 to-orange-500 rounded-2xl w-15 p-3 mb-3">
                    <h2 class="text-2xl">Ortodontia</h2>
                    <p>Aparelhos modernos para alinhar seu sorriso perfeitamente</p>
                </div>
            </div>
        </div>
        <div class="flex flex-col text-center justify-center items-center mt-16">
            <h1 class="text-5xl text-center">Depoimento de clientes</h1>
            <p>Avaliações reais de quem confia na DentalLux</p>
            <div class="flex flex-wrap justify-center gap-10 mt-8">
                <div class="flex flex-col justify-between bg-white shadow-md hover:shadow-xl transition-shadow rounded-xl p-5 md:w-90 w-80 h-50">
                    <h2>⭐⭐⭐⭐⭐</h2>
